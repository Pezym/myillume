  ...
  return (
    <div>
      ...
      <section className="md:hidden relative min-h-[85vh] bg-background overflow-hidden">
        ...
        <img src={heroAmbassador} alt="Illumé ambassador" className="absolute inset-0 w-full h-full <img src={heroAmbassador} alt="Illumé ambassador" className="absolute inset-0 w-full h-full object-cover object-[center_55%]" /> />
